...
class _PaymentsApi implements PaymentsApi {
  ...
  Future<ApiResponse<List<PaymentRecord>>> getPayments({
    ...
    final queryParameters = <String, dynamic>{
      r'page': page,
      r'status': status,
      r'farmer_id': farmerId,
    };
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<List<PaymentRecord>>>(
    ...
    late ApiResponse<List<PaymentRecord>> _value;
    try {
      _value = ApiResponse<List<PaymentRecord>>.fromJson(
        _result.data!,
        (json) => json is List<dynamic>
            ? json
                  .map<PaymentRecord>(
                    (i) => PaymentRecord.fromJson(i as Map<String, dynamic>),
                  )
                  .toList()
            : List.empty(),
      );
  ...
  @override
  Future<ApiResponse<PaymentRecord>> getPayment(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
