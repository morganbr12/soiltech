...
mixin _$ApiResponse<T> {
 ...
 bool get success; T? get data; String? get message;@JsonKey(name: 'status_code') int? get statusCode; PaginationMeta? get meta;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,success,const DeepCollectionEquality().hash(data),message,statusCode,meta);

@override
String toString() {
  return 'ApiResponse<$T>(success: $success, data: $data, message: $message, statusCode: $statusCode, meta: $meta)';
}
...
@useResult
$Res call({
 bool success, T? data, String? message,@JsonKey(name: 'status_code') int? statusCode, PaginationMeta? meta
});
...
/// Create a copy of ApiResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? success = null,Object? data = freezed,Object? message = freezed,Object? statusCode = freezed,Object? meta = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool success,  T? data,  String? message, @JsonKey(name: 'status_code')  int? statusCode,  PaginationMeta? meta)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ApiResponse() when $default != null:
return $default(_that.success,_that.data,_that.message,_that.statusCode,_that.meta);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool success,  T? data,  String? message, @JsonKey(name: 'status_code')  int? statusCode,  PaginationMeta? meta)  $default,) {final _that = this;
switch (_that) {
case _ApiResponse():
return $default(_that.success,_that.data,_that.message,_that.statusCode,_that.meta);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool success,  T? data,  String? message, @JsonKey(name: 'status_code')  int? statusCode,  PaginationMeta? meta)?  $default,) {final _that = this;
switch (_that) {
case _ApiResponse() when $default != null:
return $default(_that.success,_that.data,_that.message,_that.statusCode,_that.meta);case _:
  return null;
...
class _ApiResponse<T> implements ApiResponse<T> {
  const _ApiResponse({required this.success, this.data, this.message, @JsonKey(name: 'status_code') this.statusCode, this.meta});
...
/// Create a copy of ApiResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? success = null,Object? data = freezed,Object? message = freezed,Object? statusCode = freezed,Object? meta = freezed,}) {
...
mixin _$PaginationMeta {
 ...
 int get total; int get page;@JsonKey(name: 'per_page') int get perPage;@JsonKey(name: 'last_page') int get lastPage;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PaginationMeta&&(identical(other.total, total) || other.total == total)&&(identical(other.page, page) || other.page == page)&&(identical(other.perPage, perPage) || other.perPage == perPage)&&(identical(other.lastPage, lastPage) || other.lastPage == lastPage));
}
...
@override
String toString() {
  return 'PaginationMeta(total: $total, page: $page, perPage: $perPage, lastPage: $lastPage)';
}
...
@useResult
$Res call({
 int total, int page,@JsonKey(name: 'per_page') int perPage,@JsonKey(name: 'last_page') int lastPage
});
...
/// Create a copy of PaginationMeta
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? total = null,Object? page = null,Object? perPage = null,Object? lastPage = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int total,  int page, @JsonKey(name: 'per_page')  int perPage, @JsonKey(name: 'last_page')  int lastPage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PaginationMeta() when $default != null:
return $default(_that.total,_that.page,_that.perPage,_that.lastPage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int total,  int page, @JsonKey(name: 'per_page')  int perPage, @JsonKey(name: 'last_page')  int lastPage)  $default,) {final _that = this;
switch (_that) {
case _PaginationMeta():
return $default(_that.total,_that.page,_that.perPage,_that.lastPage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int total,  int page, @JsonKey(name: 'per_page')  int perPage, @JsonKey(name: 'last_page')  int lastPage)?  $default,) {final _that = this;
switch (_that) {
case _PaginationMeta() when $default != null:
return $default(_that.total,_that.page,_that.perPage,_that.lastPage);case _:
  return null;
...
class _PaginationMeta implements PaginationMeta {
  const _PaginationMeta({required this.total, required this.page, @JsonKey(name: 'per_page') required this.perPage, @JsonKey(name: 'last_page') required this.lastPage});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PaginationMeta&&(identical(other.total, total) || other.total == total)&&(identical(other.page, page) || other.page == page)&&(identical(other.perPage, perPage) || other.perPage == perPage)&&(identical(other.lastPage, lastPage) || other.lastPage == lastPage));
}
...
/// Create a copy of PaginationMeta
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? total = null,Object? page = null,Object? perPage = null,Object? lastPage = null,}) {
